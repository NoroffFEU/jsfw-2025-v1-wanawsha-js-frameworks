...
export function CartProvider({ children }: { children: React.ReactNode }) {
    ...
    const total = useMemo(() => {
        ...
        const unitPrice = i.discountedPrice < i.price ? i.discountedPrice : i.price;
        return sum + unitPrice * i.quantity;
        }, 0);
    }, [items]);

    const value: CartContextValue = { items, cartCount, total, addToCart, removeFromCart, updateQuantity, clearCart };
